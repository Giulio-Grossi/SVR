...
binder<-function(wd1, wd2, sp){
  ...
  load(paste0(wd1, "/bias.ss", sp, "tt10ee1.RData"))
  bias_l[[1]]=bias
  load(paste0(wd2, "/bias.ss", sp, "tt10ee1.RData"))
  bias_l[[1]]=c(bias_l[[1]], bias)
  
  load(paste0(wd1, "/bias.ss", sp, "tt10ee2.RData"))
  bias_l[[2]]=bias
  load(paste0(wd2, "/bias.ss", sp, "tt10ee2.RData"))
  bias_l[[2]]=c(bias_l[[2]], bias)
  
  load(paste0(wd1, "/bias.ss", sp, "tt10ee3.RData"))
  bias_l[[3]]=bias
  load(paste0(wd2, "/bias.ss", sp, "tt10ee3.RData"))
  bias_l[[3]]=c(bias_l[[3]], bias)
  
  load(paste0(wd1, "/bias.ss", sp, "tt20ee1.RData"))
  bias_l[[4]]=bias
  load(paste0(wd2, "/bias.ss", sp, "tt20ee1.RData"))
  bias_l[[4]]=c(bias_l[[4]], bias)
  
  load(paste0(wd1, "/bias.ss", sp, "tt20ee2.RData"))
  bias_l[[5]]=bias
  load(paste0(wd2, "/bias.ss", sp, "tt20ee2.RData"))
  bias_l[[5]]=c(bias_l[[5]], bias)
  
  load(paste0(wd1, "/bias.ss", sp, "tt20ee3.RData"))
  bias_l[[6]]=bias
  load(paste0(wd2, "/bias.ss", sp, "tt20ee3.RData"))
  bias_l[[6]]=c(bias_l[[6]], bias)
  
  load(paste0(wd1, "/bias.ss", sp, "tt40ee1.RData"))
  bias_l[[7]]=bias
  load(paste0(wd2, "/bias.ss", sp, "tt40ee1.RData"))
  bias_l[[7]]=c(bias_l[[7]], bias)
  
  load(paste0(wd1, "/bias.ss", sp, "tt40ee2.RData"))
  bias_l[[8]]=bias
  load(paste0(wd2, "/bias.ss", sp, "tt40ee2.RData"))
  bias_l[[8]]=c(bias_l[[8]], bias)
  
  load(paste0(wd1, "/bias.ss", sp, "tt40ee3.RData"))
  bias_l[[9]]=bias
  load(paste0(wd2, "/bias.ss", sp, "tt40ee3.RData"))
  bias_l[[9]]=c(bias_l[[9]], bias)
  
    ##### MSE
  
  load(paste0(wd1, "/mse.ss", sp, "tt20ee2.RData"))
  mse_l[[5]]=mse
  load(paste0(wd2, "/mse.ss", sp, "tt20ee2.RData"))
  mse_l[[5]]=c(mse_l[[5]], mse)
  
  load(paste0(wd1, "/mse.ss", sp, "tt20ee3.RData"))
  mse_l[[6]]=mse
  load(paste0(wd2, "/mse.ss", sp, "tt20ee3.RData"))
  mse_l[[6]]=c(mse_l[[6]], mse)
  
  load(paste0(wd1, "/mse.ss", sp, "tt40ee1.RData"))
  mse_l[[7]]=mse
  load(paste0(wd2, "/mse.ss", sp, "tt40ee1.RData"))
  mse_l[[7]]=c(mse_l[[7]], mse)
  
  load(paste0(wd1, "/mse.ss", sp, "tt40ee2.RData"))
  mse_l[[8]]=mse
  load(paste0(wd2, "/mse.ss", sp, "tt40ee2.RData"))
  mse_l[[8]]=c(mse_l[[8]], mse)
  
  load(paste0(wd1, "/mse.ss", sp, "tt40ee3.RData"))
  mse_l[[9]]=mse
  load(paste0(wd2, "/mse.ss", sp, "tt40ee3.RData"))
  mse_l[[9]]=c(mse_l[[9]], mse)
